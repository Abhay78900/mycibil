      ...
      <CardContent className="pt-6">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          <div className="p-4 rounded-lg bg-score-excellent/10 text-center">
            ...
            <p className="text-2xl font-bold text-score-excellent">{data.active_accounts}</p>
          ...
          <div className="p-4 rounded-lg bg-muted/50 text-center">
            ...
            <p className="text-2xl font-bold">{data.closed_accounts}</p>
          ...
          <div className="p-4 rounded-lg bg-destructive/10 text-center">
            ...
            <p className="text-2xl font-bold text-destructive">
              ₹{data.total_overdue_amount.toLocaleString('en-IN')}
            </p>
          ...
          <div className="p-4 rounded-lg bg-muted/50 text-center">
            ...
            <p className="text-2xl font-bold">
              ₹{data.total_sanctioned_amount.toLocaleString('en-IN')}
            </p>
          ...
          <div className="p-4 rounded-lg bg-muted/50 text-center">
            <IndianRupee className="w-6 h-6 mx-auto mb-2 text-primary" />
            <p className="text-2xl font-bold">
              ₹{data.total_current_balance.toLocaleString('en-IN')}
            </p>
